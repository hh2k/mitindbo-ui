...
export const routes: Routes = [
  ...
  {
    path: 'tags',
    loadComponent: () => import('./tags/tags-list.component').then(m => m.TagsListComponent),
    canActivate: [authGuard]
  },
  {
    path: 'places',
    loadComponent: () => import('./places/places-list.component').then(m => m.PlacesListComponent),
    canActivate: [authGuard]
  },
